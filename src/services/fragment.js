const getFragmentsFor = (fragments, name) =>
...
export const addressInvalid = fragments => {
  const documentStoreIssuedFragment = getFragmentsFor(
    fragments,
    "OpenAttestationEthereumDocumentStoreIssued"
  );
  const tokenRegistryMintedFragment = getFragmentsFor(
    fragments,
  ...
  return (
    ...
    (tokenRegistryMintedFragment &&
      tokenRegistryMintedFragment.reason &&
      tokenRegistryMintedFragment.reason.code === 2)
  );
};
...
export const certificateNotIssued = fragments => {
  ...
  return (
    ...
    (tokenRegistryMintedFragment &&
      tokenRegistryMintedFragment.reason &&
      tokenRegistryMintedFragment.reason.code === 1)
  );
};
