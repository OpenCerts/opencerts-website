...
import { formatDDMMMYYYY, formatBold } from "./functions";
  ...
  <div className="row">
    ...
    <div className="col-12" style={{ fontSize: "0.9rem" }}>
      ...
      <p>
        ...
        module for which grade point or modular credit is not accorded will not
        be considered in the computation of the cGPA.
      </p>
      <div
        className="row"
