...
const getCertSignatures = certSignatories => (
  <div className="col-5 text-center">
    {certSignatories.map(signatureData => (
      <div>
...
const getCertInfoSection = (id, issuedOn) => (
  <div className="col-5 my-5">
    ...
    {issuedOn &&
      <div className="mb-4 mb-lg-3 d-flex justify-content-center">
        Date of award: {format(issuedOn, "DD MMMM YYYY")}
      </div>
    }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ fontFamily: "'Noto Serif', serif", maxWidth: 900 }} className="container">
          ...
          >
            <p>
              has successfully completed the above course and has passed the prescribed
              examinations leading the award of the
            </p>
          </div>
          <div
            style={{
          ...
          >
            <b>{certificateName}{merit && ` (${merit})`}</b>
          </div>
          <div
            style={{ fontSize: "1.4rem" }}
