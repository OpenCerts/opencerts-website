    ...
    <div className="col-md-12">
      <div className="row">
        ...
        <div className="col-md-11" valign="top" style={EXPLANATORY_CONTENT}>
          ...
          and the University of Cambridge International Examination (CIE) are
          joint examining authorities for the General Cerfificate of Education
      ...
      <div className="row">
        ...
        <div className="col-md-11" valign="top" style={EXPLANATORY_CONTENT}>
          ...
          subjects is indicated as Distinction, Merit, Pass and Ungraded.
        </div>
      </div>
      <div className="row">
        <div className="col-md-12">&nbsp;</div>
      ...
      <div className="row">
        ...
        <div className="col-md-11" valign="top" style={EXPLANATORY_CONTENT}>
          ...
          Pass, Ungraded. Mother Tongue B is not an O-Level subject.
        </div>
      </div>
      <div className="row">
        <div className="col-md-12">&nbsp;</div>
      ...
      <div className="row">
        ...
        <div className="col-md-11" valign="top" style={EXPLANATORY_CONTENT}>
          ...
          <br />
          <br />
          <b>#Examption Symbol</b>
          <br />
          The candidate was exampted from satisfying the full range of
