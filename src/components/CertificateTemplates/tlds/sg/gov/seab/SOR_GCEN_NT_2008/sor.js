...
export const renderTranscript = ({ certificate }) => {
  ...
  const transcriptDetailsGCENNT = transcript.map(trn => (
    <div className="row" style={SOR_TRANSCRIPT_FONT_SIZE_11}>
      <div className="col-md-12">
        <div className="row">
          ...
          <div className="col-sm-1">{trn.level}</div>
          <div className="col-sm-2">{trn.languageMedium}</div>
