...
import { IMG_LOGO, IMG_SEAL, IMG_SSGLOGO, IMG_SCDF } from "../common";
...
export const renderSignature = certificate => (
  ...
  >
    ...
    <div
      className="col-lg-3 col-xs-12 d-flex"
    ...
    >
      ...
      <p style={{ color: "rgb(51,0,144)", textAlign: "center" }}>
        In partnership with
      </p>
      <div
        className="row d-flex justify-content-center"
      ...
      >
        <div className="col-lg-10 col-10" style={{ textAlign: "end" }}>
          <img style={footerLogoStyle} src={IMG_SCDF} />
          <a href="www.scdf.gov.sg" style={{ color: "rgb(51,0,144)" }}>
            www.scdf.gov.sg
          </a>
        </div>
        <div className="col-lg-2 col-2" style={certCodeStyle}>
