...
import { IMG_LOGO, IMG_SEAL, IMG_SSGLOGO, IMG_ECDA } from "../common";
  ...
  >
    ...
    <div className="col-lg-7">
      ...
      <div style={footerTextStyle}>
        ...
        and the Early Childhood Development Agency (ECDA) Accreditation
        Standards for Early Childhood Teacher Training Courses.
      </div>
      <div style={footerTextStyle}>
    ...
    <div className="col-lg-3 col-xs-12">
      ...
      <div>
        ...
        <img style={footerLogoStyle} src={IMG_ECDA} />
