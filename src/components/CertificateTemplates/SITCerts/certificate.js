import { SIT_CERT_BORDER, SIT_CERT_BG, SIT_CERT_LOGO, SIT_CERT_SEAL, SIT_PRESIDENT, SIT_DEP_PRESIDENT } from "./images";
...
<div className="container" style={ borderImgStyle }>
	<div style={bgImgStyle}>
		...
		<div className="row d-flex justify-content-center">
			<span style={arial18PtRedBold}>{certificate.additionalData.degreeName1}</span>
		</div>
		<div className="row d-flex justify-content-center">
			<span style={arial18PtRed}>{certificate.additionalData.degreeName2}</span>
		</div>
		<div className="row d-flex justify-content-center">
			...
			<div className="col-md-4">
				<div className="row">
					<div className="col-md-12 text-center">
						<img src={certificate.additionalData.sitPresidentSign} style={presidentStyle} />
					</div>
				</div>
				<div className="row">
					<div className="col-md-12 text-center">
				...
				<div className="row">
					<div className="col-md-12 text-center">
						<img src={certificate.additionalData.sitDepPresidentSign} style={depPresidentStyle} />
					</div>
				</div>
				<div className="row">
					<div className="col-md-12 text-center">
