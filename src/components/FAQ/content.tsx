    ...
    faq: [
      ...
      },
      {
        ...
        answer: (
          <ul>
            <li>
              <b>If an institution is in the SkillsFuture registry for OpenCerts</b>, it means that the identity of the
            ...
            <li>
              <b>If an institution is NOT in the SkillsFuture registry for OpenCerts</b>, we still verify the identity
